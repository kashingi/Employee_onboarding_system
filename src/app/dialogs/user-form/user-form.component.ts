...
export class UserFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.userForm = this.formBuilder.group({
      ...
      phoneNumber: [
        ...
        [
          Validators.required,
          Validators.pattern(GolobalConstants.contactNumberRegex),
        ],
      ],
      idNumber: [
        null,
        [Validators.required, Validators.pattern(GolobalConstants.idNumber)],
      ],
      address: [null, [Validators.required]],
      userProfile: [
        null,
        [Validators.required, GolobalConstants.imageFileValidator],
      ],
    ...
    this.userForm.controls['employeeCV'].valueChanges.subscribe(
      (file: File) => {
        this.selectedCV = file;
      }
    );

    this.userForm.controls['userProfile'].valueChanges.subscribe(
      (file: File) => {
    ...
    if (this.dialogData.action === 'Edit') {
      ...
      const passGraduation = this.passGration(
        this.dialogData.data.graduationYear
      );
  ...
  onCVSelected(event: any): void {
    ...
    if (file) {
      ...
      reader.onload = () => {
        ...
        this.userForm.controls['employeeCV'].setValue(base64String);
  ...
  add() {
    ...
    var data: any = {
      ...
      graduationYear: this.datePipe.transform(
  ...
  edit() {
    ...
    Object.keys(userData).forEach(
      (key) =>
        (userData[key] == null || userData[key] === '') && delete userData[key]
    );
